...
furnishing_attributes = [
  ...
  { title: "Vintage Danish Teak Table Lamp", description: "Beautiful Lamp from the 1960s", price: 100, location: "London", furnishing_type: "Lamp" },
  ...
  { title: "Pair of Green Glass Lamps", description: "Beautiful Lamp from the 1960s", price: 100, location: "London", furnishing_type: "Lamp" },
